...
namespace Nickvision::Keyring::SystemCredentials
{
	 ...
	 */
	std::optional<Credential> getCredential(const std::string& name) noexcept;
	/**
	 ...
	 */
	std::optional<Credential> addCredential(const std::string& name) noexcept;
	/**
	 ...
	 * @return True if successful, else false
	 */
	bool deleteCredential(const std::string& name) noexcept;
}
